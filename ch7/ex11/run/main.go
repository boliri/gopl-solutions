...
func landing(w http.ResponseWriter, req *http.Request) {
	b, err := json.MarshalIndent(db.GetAll(), "", "    ")
	if err != nil {
		http.Error(w, "could not pretty-print database", http.StatusInternalServerError)
		return
	}
...
func read(w http.ResponseWriter, req *http.Request) {
	...
	if err != nil {
		http.Error(w, "could not pretty-print item", http.StatusInternalServerError)
		return
	}
