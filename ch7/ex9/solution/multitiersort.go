...
//go:embed tpl/table.html
var rawTpl string

var tableTpl *template.Template = template.Must(template.New("tracks").Parse(rawTpl))
...
func (t *clickableTable) PrintHtml(w io.Writer) {
	tableTpl.Execute(w, t.Mts.table)
}
